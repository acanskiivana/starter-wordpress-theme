...
function custom_theme_scripts() {
	...
	$manifest = json_decode(file_get_contents(get_template_directory() . '/assets/css/rev-manifest.json'), true);
	$main_css = $manifest['style.css'];
	
	$manifest_js = json_decode(file_get_contents(get_template_directory() . '/assets/js/rev-manifest.json'), true);
	$main_js = $manifest_js['main.min.js'];
	
	wp_enqueue_style('my-theme-style', get_template_directory_uri() . '/assets/css/' . $main_css);
	wp_enqueue_script('my-theme-scripts', get_template_directory_uri() . '/assets/js/' . $main_js, array(), false, true);
